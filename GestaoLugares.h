...
void carregarLugaresIndisponiveis(Lugar mapa[][MAX_FILAS][MAX_LUGARES], Confparque config);
void guardarLugaresIndisponiveis(Lugar mapa[][MAX_FILAS][MAX_LUGARES], Confparque config);
